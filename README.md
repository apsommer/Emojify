...
This is an Android app that adds emojis to photos using facial recognition from the [Google Mobile Vision API](https://developers.google.com/vision/), created as part of the [Android Developer Nanodegree by Google](https://www.udacity.com/course/android-developer-nanodegree-by-google--nd801).
